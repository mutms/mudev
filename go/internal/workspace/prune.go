...
// up. `mudev list` marks recorded-but-absent checkouts with ✗, so it doubles
// as the preview — though a directory that is still there but lost its .git
// carries the same mark and is left recorded, not pruned.
