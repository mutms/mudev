...
// .yaml/.yml/.json, which makes ad-hoc private recipes
// ("somecustomer-4.5.12.yaml") work without a catalogue — or a catalogue
// identifier vendor/stream/version resolved under recipesDir.
