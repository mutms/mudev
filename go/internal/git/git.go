...
//
// Run before a fetch: a shallow checkout is an assembly-time optimisation,
// and a plain fetch into it would leave it shallow — the moment someone asks
// for updates they should get the full history and tags instead.
