...
//
// An existing manifest is left alone unless Force is set. The file is meant to
// be edited by hand after generation — that is where the prose goes — so a
// second run must not quietly undo the author's work.
